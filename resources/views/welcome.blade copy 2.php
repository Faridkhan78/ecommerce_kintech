<body>
                                                    ...
                                                    <div
                                                        ...
                                                        {{-- <div class="product-card">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <!-- Quantity Input -->
                                                                <input type="number"
                                                                    class="form-control qty-input mx-2" value="1"
                                                                    min="1"
    ...
    <script>
        // Function to show quantity input and hide "Add to cart"
        document.getElementById("button-<?php echo $row['category_id']; ?>").addEventListener("click", function() {
            document.querySelector(".quantity-<?php echo $row['category_id']; ?>").style.display = "flex";
            document.getElementById("button-<?php echo $row['category_id']; ?>").style.display = "none";
        });

        // Increase quantity button
        document.getElementById("btn-plus-<?php echo $row['category_id']; ?>").addEventListener("click", function() {
            let quantity = parseInt(document.getElementById("quantity-input-<?php echo $row['category_id']; ?>").value);
            document.getElementById("quantity-input-<?php echo $row['category_id']; ?>").value = quantity + 1;
        });

        // Decrease quantity button and show "Add to cart" when quantity is 0
        document.getElementById("btn-minus-<?php echo $row['category_id']; ?>").addEventListener("click", function() {
            let quantity = parseInt(document.getElementById("quantity-input-<?php echo $row['category_id']; ?>").value);
            if (quantity > 1) {
                document.getElementById("quantity-input-<?php echo $row['category_id']; ?>").value = quantity - 1;
            } else {
                document.querySelector(".quantity-<?php echo $row['category_id']; ?>").style.display = "none";
                document.getElementById("button-<?php echo $row['category_id']; ?>").style.display = "inline-block";
            }
        });
    </script>
