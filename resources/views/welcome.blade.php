                                            ...
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="product-card">
                                                        ...
                                                        $cartItemIds = collect($cartItemIds)->pluck('prodid')->toArray();  // Convert to collection and pluck 'prodid'
                                                        // dd($cartItemIds);
                                                        @endphp --}}
                                                        ...
                                                        <div class="d-flex align-items-center"
                                                            ...
                                                            <!-- Decrement Button -->
                                                            <button class="btn btn-outline-danger btn-sm decrease-qty"
                                                                data-id="{{ $product->id }}">-</button>

                                                            <!-- Quantity Input -->
                                                            <input type="text" class="form-control qty-input mx-2"
                                                                id="qty-{{ $product->id }}" value="1"
                                                                min="1"
                                                                style="width: 60px; text-align: center;">

                                                            <!-- Increment Button -->
                                                            <button class="btn btn-outline-success btn-sm increase-qty"
                                                                data-id="{{ $product->id }}">+</button>
                                                        </div>
