        ...
        <form action="{{route('orderplace')}}" method="POST">
            ...
            <div class="row g-5">
                <div class="col-md-12 col-lg-6 col-xl-7">
                    ...
                    <div class="form-item">
                        <label class="form-label my-3"><b>Payment Method</b><sup>*</sup></label>
                            ...
                            <div class="col-12">
                                <div class="form-check text-start my-3">
                                    <input type="radio" class="form-check-input bg-primary border-0" id="Payments-1"
                                        name="payment" value="onlinepayment">
                                    <label class="form-check-label" for="Payments-1">Online Payment</label>
                                </div>
                            </div>
                        </div>
                        <div class="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
                        ...
                        <div class="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
                            <div class="col-12">
                                <div class="form-check text-start my-3">
                                    <input type="radio" class="form-check-input bg-primary border-0" id="Paypal-1"
                                        name="payment" value="Paypal">
                                    <label class="form-check-label" for="Paypal-1">EMI Payment</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-item">
                        <textarea name="address" class="form-control" spellcheck="false" cols="30" rows="11"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    {{-- <th scope="row">
                                        <div class="d-flex align-items-center mt-2">
                                            <img src="{{ asset('user/img/vegetable-item-2.jpg')}}" class="img-fluid rounded-circle"
                                ...
                                {{-- <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center mt-2">
                                            <img src="{{ asset('user/img/vegetable-item-5.jpg')}}" class="img-fluid rounded-circle"
                                                style="width: 90px; height: 90px;" alt="">
                                        </div>
                                    </th>
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center mt-2">
                                            <img src="{{ asset('user/img/vegetable-item-3.png')}}" class="img-fluid rounded-circle"
                                                style="width: 90px; height: 90px;" alt="">
                                        </div>
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td class="py-5">
                                        <p class="mb-0 text-dark text-uppercase py-3"></p>
                                    </td>
                                    <td class="py-5"></td>
                                    <td class="py-5"></td>
                                    <td class="py-5">
